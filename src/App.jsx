...
import { geocodeCity } from './api/overpassService.js'
...
function CatTile({ cat, active, onClick, delay, solo }) {
  return (
    <button id={`cat-tile-${cat.id}`} onClick={onClick} className="anim-up" style={{
      animationDelay:`${delay}s`, position:'relative', overflow:'hidden', borderRadius:18, width:'100%', aspectRatio:solo?'2/1':'3/4',
...
function getDiscoverQueries(ageFilter) {
  if (ageFilter === '0-3') return [
    ...
    { catId:'gratuit',     subName:'Forêts & balades' },
    { catId:'pluie',       subName:'Aquarium' },
    { catId:'ateliers',    subName:'Ateliers musique' },
    { catId:'resto',       subName:'Cuisine locale' },
  ]
  if (ageFilter === '4-6') return [
    ...
    { catId:'pluie',       subName:'Trampoline' },
    { catId:'resto',       subName:'Pizzerias' },
  ]
  if (ageFilter === '13+') return [
    ...
    { catId:'culture',     subName:'Châteaux & histoire' },
    { catId:'sport',       subName:'Sports nautiques' },
    { catId:'sport',       subName:'Tennis & padel' },
    { catId:'pluie',       subName:'Bowling' },
    { catId:'nature',      subName:'Forêts & randonnée' },
    { catId:'resto',       subName:'Burgers & grill' },
  ]
  return [
    { catId:'nature',      subName:'Forêts & randonnée' },
    { catId:'nature',      subName:'Zoos & parcs animaliers' },
        ...
        <div style={{ padding:'0 10px', marginTop:-24, position:'relative', zIndex:10 }}>
          ...
          <div style={{ minWidth:64, textAlign:'center', padding:'0 8px' }}>
                  ...
                  {hasSearched && results.length > 0 && (
                    <div style={{ fontSize:10, color:'#FF6B4A', fontWeight:600, marginTop:2 }}>🔄 relancer</div>
                  )}
                </div>
                <button
