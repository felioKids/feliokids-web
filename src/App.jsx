...
const CATS = [
  ...
  { id:'ensemble',     l:'Ensemble',       sub:'Parent & enfant à 100%',   c:'#F59E0B', img:'https://images.unsplash.com/photo-1596464716127-f2a82984de30?w=400&q=75', subs:['Bébé nageur','Atelier peinture','Cuisine parent-enfant','Yoga parent-enfant','Éveil musical','Jardinage','Escalade débutants','Théâtre parent-enfant'] },
